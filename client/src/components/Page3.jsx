  ...
  return (
    <div className="page-container">
      ...
      <div className="page3-card">
        ...
        <p>
          <strong>Indoor positioning</strong> is used in{" "}
          <strong>hospitals, airports, and shopping malls</strong>, where GPS is
          unreliable. Methods include:
        </p>
        <ul>
          <li>
            <strong>WiFi Fingerprinting:</strong> Mapping signal strengths for
            localization.
          </li>
          <li>
            <strong>Bluetooth Beacons:</strong> Using low-energy Bluetooth
            signals.
          </li>
          <li>
            <strong>IMU Sensors:</strong> Tracking motion via accelerometers and
            gyroscopes.
          </li>
        </ul>
